            ...
            <div className="w-full max-w-md">
                <div className="card text-center mb-8">
                    ...
                    <p className="text-[var(--color-text-secondary)]">
                        Join SavvySpend and start managing your expenses smarter
                    </p>
                </div>
                ...
                <div className="card">
                    <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                >
                                    {showPassword ? (
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.29 3.29m0 0A9.97 9.97 0 015.12 5.12m0 0L8.88 8.88M15.537 15.537a3 3 0 01-4.243-4.243" />
                                        </svg>
                                    ) : (
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex items-start">
                            <input
                                id="terms"
                                type="checkbox"
                                className="mt-1 w-4 h-4 rounded neumorphic-inset"
                                style={{ accentColor: 'var(--color-primary)' }}
                                required
                            />
                            <label htmlFor="terms" className="ml-2 text-sm text-[var(--color-text-secondary)]">
                                I agree to the{' '}
                                <a href="#" className="text-[var(--color-primary)] hover:opacity-80 transition-opacity">
                                    Terms of Service
                                </a>{' '}
                                and{' '}
                                <a href="#" className="text-[var(--color-primary)] hover:opacity-80 transition-opacity">
                    ...
                    <div className="mt-6 pt-6 border-t border-[var(--shadow-dark)]">
                        <div className="relative">
                            <div className="absolute inset-0 flex items-center">
                                <div className="w-full border-t border-[var(--shadow-dark)]"></div>
                            </div>
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-[var(--bg-color)] text-[var(--color-text-secondary)]">
                                    Or continue with
                                </span>
                            </div>
                        </div>
                    ...
                    <p className="mt-6 text-center text-sm text-[var(--color-text-secondary)]">
                        ...
                        <button
                            ...
                            className="text-[var(--color-primary)] font-semibold hover:opacity-80 transition-opacity"
                        >
                            Sign in
                        </button>
                    </p>
