            ...
            <div className="w-full max-w-md">
                <div className="card text-center mb-8">
                    ...
                    <p className="text-[var(--color-text-secondary)]">
                        Sign in to continue to SavvySpend
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="w-4 h-4 rounded neumorphic-inset"
                                    style={{ accentColor: 'var(--color-primary)' }}
                                />
                                <span className="ml-2 text-sm text-[var(--color-text-secondary)]">Remember me</span>
                            </label>
                            <a href="#" className="text-sm text-[var(--color-primary)] hover:opacity-80 transition-opacity">
                                Forgot password?
                            </a>
                        </div>
